  ...
  return (
    <nav className="flex py-5 lg:py-10 justify-between items-center text-lg bg-transparent w-full fixed top-0 z-50 backdrop-filter backdrop-blur text-opacity-100 dark:border-pWhite border-pBlack border-b">
        <ul className="flex gap-16 mx-6">
            ...
            <li className="hidden items-center md:flex"><a href="#">01. Inicio</a></li>
            <li className="hidden items-center md:flex"><a href="#about">02. Acerca de mí</a></li>
            <li className="hidden items-center md:flex"><a href="#projects">03. Proyectos</a></li>
        </ul>
        <SwitchDarkMode />
    </nav>
  )
