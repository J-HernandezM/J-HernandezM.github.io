...
export default function Header() {
  return (
    <nav className="flex py-5 lg:py-10 justify-between items-center text-lg bg-transparent w-full fixed top-0 z-50 backdrop-filter backdrop-blur text-opacity-100 border-pWhite border-b">
