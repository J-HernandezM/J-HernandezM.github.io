    ...
    resources: {
      en: {
        translation: {
          ...
          cards: {
            ananda: 'E-commerce POC showcasing the look and feel of a Shopify store before implementation. Elegant design aligned with the brand identity.',
      ...
      es: {
        translation: {
          ...
          cards: {
            ananda: 'POC de e-commerce que muestra el aspecto de una tienda en Shopify antes de su implementación real. Diseño elegante y acorde a la identidad de marca.',
